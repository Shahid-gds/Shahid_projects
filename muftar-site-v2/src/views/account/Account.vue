<template>
    <div class="index mt-40 w-full flex items-center justify-between 2xl:px-56 md:px-24 px-10">
      ...
      <div class="container mx-auto pb-10 px-6">
       ...
       <div>
        <div class="profile-div sm:w-40 sm:h-40 rounded-full -mt-20 p-8">
            <div class="relative w-full h-full">
                <img class="w-full h-full object-cover" :src="profileImage" alt="">
            </div>
            <input  ref="fileInput" type="file" style="display:none;" @change="handleFileUpload">          
        </div>
        <div v-if="editMode" @click="openFileInput" class="upload-profile w-10 h-10 -mt-10 ml-28 rounded-full p-2 cursor-pointer">
       ...
       <div class="public-profile mt-8 border-t-2 border-b-2 py-6 md:flex items-start">
           ...
           <div class="sm:flex items-center sm:space-x-10 xl:ml-36 mx-auto w-full">
            <!-- <div class="profile-div w-28 h-28 rounded-full p-6">
             ...
             <div class="xl:w-3/5 w-full space-y-4">
               <div class="lg:flex w-full lg:space-x-3">
                <div class="relative text-gray-600 w-full pb-5">
                    <input class="border-2 w-full rounded-md p-2 px-12 outline-none" :class="{ 'text-black border-[#3C5AA8]': editMode }" type="Text" placeholder="User Name" v-model="fname"
                    :readonly="!editMode">
                ...
                <div class="relative text-gray-600 w-full ">
                    <input class="border-2 w-full rounded-md p-2 px-12 outline-none" :class="{ 'text-black border-[#3C5AA8]': editMode }" type="Text" placeholder="Last Name" v-model="lname"
                    :readonly="!editMode">
                    <div class="absolute left-4 top-0 mt-2">
                       <svg xmlns="http://www.w3.org/2000/svg" width="19.335" height="19.335" viewBox="0 0 19.335 19.335">
                           <path id="Icon_awesome-user-alt" data-name="Icon awesome-user-alt" d="M9.667,10.876A5.438,5.438,0,1,0,4.229,5.438,5.439,5.439,0,0,0,9.667,10.876ZM14.5,12.084H12.42a6.574,6.574,0,0,1-5.506,0H4.834A4.833,4.833,0,0,0,0,16.918v.6a1.813,1.813,0,0,0,1.813,1.813H17.522a1.813,1.813,0,0,0,1.813-1.813v-.6A4.833,4.833,0,0,0,14.5,12.084Z" fill="#dbdbdb"/>
                ...
                <div class="lg:flex w-full lg:space-x-3">
                    <div class="relative text-gray-600 w-full pb-5">
                        <input class="border-2 w-full rounded-md p-2 px-12 outline-none" :class="{ 'text-black border-[#3C5AA8]': editMode }" type="Text" placeholder="123-45678910" v-model="phone"
                        :readonly="!editMode">
                    ...
                    <div class="relative text-gray-600 w-full">
                        <input class="border-2 w-full rounded-md p-2 px-12 outline-none" :class="{ 'text-black border-[#3C5AA8]': editMode }" type="Text" placeholder="website123example.com" v-model="website"
                        :readonly="!editMode">
                        <div class="absolute left-4 top-0 mt-2.5">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#dbdbdb" class="w-6 h-6">
        ...
        <!-- <div class="profile-div w-28 h-28 rounded-full p-6">
         ...
         <div class="xl:w-3/5 w-full space-y-4">
            <div class="relative text-gray-600 ">
                <div class="">
                    <input
                    class="border-2 w-full rounded-md p-4 outline-none"
                    type="text"
                    :value="affiliateLink"
                    readonly
                  />
                  <div class="sm:absolute left-[25rem] top-0 mt-0">
                    <button
                    class="sm:rounded-r-md"
                    @click="copyLink"
                  >
...
const getUserData = async () => {
  ...
  try {
    const response = await axios.get('https://ecostructure-demo.muftar.com/user', 
    { headers });
...
const saveUserData = async (imageUrl) => {
    ...
    try {
        ...
        await axios.post('https://ecostructure-demo.muftar.com/user/update', 
