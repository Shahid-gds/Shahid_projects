<template>
<div>
  <form class="bg-white rounded px-8 py-8 mb-4 flex flex-col justify-center item-center">
    <!-- first -->
    <div class="flex">
    <div class="mb-4 m-5">
      ...
      <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Broker Name"
        v-model="bol_gen.broker.name"
        >
    </div>
    ...
    <div class="flex">
      ...
      <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="User input">
    </div>
    <div class="mb-4 m-5">
      <div class="flex">
    ...
    <div class="flex">
      ...
      <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="new name">
    </div>
    <div class="mb-4 m-5">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
        old name
      </label>
      <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="old name">
    </div>
    </div>
    <!-- fourth -->
    <div class="flex">
    ...
    <div class="flex">
      ...
      <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
    </div>
    <div class="mb-4 m-5">
      <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Select an option</label>
<select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
export default {
  ...
  methods:{
    saveBol(){
      this.$emit('saveBol', this.bol_gen)
    }
  },
  data(){
    return{
