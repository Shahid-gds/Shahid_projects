<template>
  <div class="w-full p-3 bg-[#3A54B4] footer-section">
        ...
        <div class="">
          ...
          <div class="flex space-x-10 mt-3 items-center">
           ...
           <a href=" https://web.facebook.com/muftarcorp/?_rdc=1&_rdr">
            ...
            <div>
              <a href="https://youtu.be/pGa7SLd9bJk?si=4JvL1TiO-KqGgG4k">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" fill="white" viewBox="0 0 24 24">
    ...
    <div class="text-white text-center sm:mt-16 copy-right">
      <p>Copyright © 2023 Muftar Corp. All Rights Reserved</p>
    </div>
  </div>
</template>
<script setup>
