<template>
    <div id="OrdersHistory">
        <h2 class="text-xl font-bold ml-10 m-0 text-primary mb-2">History</h2>
        ...
        (ld.id).substring(ld.id.length - 5) }} <span v-if="copiedId == ld.id"
                        ...
                        <p class="text-xs  my-auto cursor-pointer"
                        ...
                        <div class="flex justify-center item-center">
                            <div class="mt-1">
                                ...
                                <button v-if="ld.status === 'completed'"
                                    class=" px-3 w-full py-2 rounded-md bg-green-600 text-white"
