<template>
<div class="m-4">
    <div class="w-5/12 mx-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
    <header class="flex flex-col justify-center items-center">
        ...
        >
        <img class="w-full h-auto" src="@/assets/gfx/card_design.png" alt="front credit card">
    ...
    <main class="mt-4 p-4">
        <h1 class="text-xl font-semibold text-gray-700 text-center">Add payment</h1>
        <p class="italic text-gray-300">We charge a 3% convience for all card payments for credit card processing</p>
        <div class="">
        <div class="my-3">
            <input
            type="text"
