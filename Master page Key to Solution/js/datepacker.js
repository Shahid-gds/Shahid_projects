class DateRangePicker {
    ...
    static #month = ['January', 'Febuary', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    ...
    static #generateYearSelector(instance, tableContainer) {
        ...
        divInputContainer.innerHTML = `
            <input class="cal-year-input" name="year-input" type="number" min="1900" max="2099" step="1" placeholder="Select Year"/>
        `;
