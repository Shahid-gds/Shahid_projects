                ...
                <div class="px-6 mt-6 ">
                    <div class="flex space-x-2">
                        <div
                          ...
                          :class="{
                            'bg-[#EDEDF3]': true,
                            'bg-[#B6CBEF] text-[#3C5AA8] font-[900]': activeIndex === index,
                            'p-4': true,
                            'w-full': true,
                            'rounded-xl': true,
                            'text-center': true,
                    ...
                    <div class="p-2 px-6 rounded-xl flex justify-between items-center bg-[#EDEDF3] mt-2">
                        <div class="text-xs">
