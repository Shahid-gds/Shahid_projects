...
; (function ($) {
    ...
    var arlo_tm_animate_text = function() {
        ...
        animateSpan.typed({ strings: ["Begining", "Solutions", "Quality"], loop: true, startDelay: 1e3, backDelay: 2e3 });
    }
    var arlo_tm_animate_text2 = function() {
        var animateSpan = jQuery(".arlo_tm_animation_text_word2");
        animateSpan.typed({ strings: ["Team", "clients", "Campanies"], loop: true, startDelay: 1e3, backDelay: 2e3 });
    }
    var arlo_tm_animate_text3 = function() {
        var animateSpan = jQuery(".arlo_tm_animation_text_word3");
        animateSpan.typed({ strings: ["Anywhere", "Everyone", "Whatever"], loop: true, startDelay: 1e3, backDelay: 2e3 });
    }
